...
public:
	...
	virtual void			ClientSpawned( edict_t *pPlayer ) /*OVERRIDE*/; // TODO
};
...
public:
	...
	virtual bool			ReplayInit( CreateInterfaceFn fnReplayFactory ) /*OVERRIDE*/; // TODO
	...
	virtual void			SetServerHibernation( bool bHibernating ) /*OVERRIDE*/; // TODO
	...
	virtual void			GameServerSteamAPIShutdown( void ) /*OVERRIDE*/; // TODO

	// interface to the new GC based lobby system
	virtual IServerGCLobby *GetServerGCLobby() /*OVERRIDE*/; // TODO

	virtual const char *GetServerBrowserMapOverride() /*OVERRIDE*/; // TODO
	virtual const char *GetServerBrowserGameData() /*OVERRIDE*/; // TODO

	// Called to add output to the status command
	virtual void 			Status( void (*print) (const char *fmt, ...) ) /*OVERRIDE*/; // TODO

	virtual void PrepareLevelResources( /* in/out */ char *pszMapName, size_t nMapNameSize,
	                                    /* in/out */ char *pszMapFile, size_t nMapFileSize ) /*OVERRIDE*/; // TODO

	enum ePrepareLevelResourcesResult
	{
		ePrepareLevelResources_Stub
	};
	...
	{
		eCanProvideLevel_Stub
	};
	
	virtual eCanProvideLevelResult CanProvideLevel( /* in/out */ char *pMapName, int nMapNameMax ) /*OVERRIDE*/; // TODO

	// Called to see if the game server is okay with a manual changelevel or map command
	virtual bool			IsManualMapChangeOkay( const char **pszReason ) /*OVERRIDE*/; // TODO
